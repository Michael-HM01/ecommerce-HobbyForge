/* ============================================================
   ...
   - Delete product
   - Add product
   - Maintain cart integrity when product data changes
   ============================================================ */
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  /*
   Cart.js may not be loaded on an isolated admin page in future
   revisions, so this guard prevents errors.
  */
  if (typeof reconcileCart === "function") {
    reconcileCart();
  }
...
function saveEditedProduct() {
  ...
  /* Keep existing cart quantities valid after stock changes */
  if (typeof reconcileCart === "function") {
    reconcileCart();
  }
...
function initAdminEditModal() {
  ...
  if (saveBtn) {
    saveBtn.addEventListener("click", saveEditedProduct);
  }
}
...
function deleteProduct(productId) {
  ...
  /* Remove deleted product from any existing cart */
  if (typeof reconcileCart === "function") {
    reconcileCart();
  }
