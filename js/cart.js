/* ============================================================
   ...
   - Cart reconciliation against current product data
...
/* ============================================================
   Cart integrity
   ------------------------------------------------------------
   Ensures cart data always matches the current product data.

   Rules:
   - Remove items whose products no longer exist.
   - Remove items that are out of stock.
   - Remove invalid quantities.
   - Limit cart quantity to current available stock.
